...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0d1526' }}>
      {/* Left panel */}
      <div className="hidden lg:flex lg:w-5/12 flex-col justify-between p-12" style={{ background: '#090e1b', borderRight: '1px solid #1e2d47' }}>
          ...
          <div className="space-y-4">
            {FEATURES.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: 'rgba(59,130,246,0.15)' }}>
        ...
        <p className="text-slate-700 text-xs">© {new Date().getFullYear()} NetSupportAI. All rights reserved.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="font-bold text-white">NetSupportAI</span>
          </div>
          ...
          <div className="card p-8">
            ...
            <div className="mt-6 pt-5" style={{ borderTop: '1px solid #1e2d47' }}>
              <p className="text-xs text-slate-500 text-center">
                Client?{' '}
                <a href="/client-portal" className="text-blue-400 hover:text-blue-300 font-medium transition-all duration-200">
